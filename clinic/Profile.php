...
?>		
					...
					<p id = "side_profile"> <img src="person-icon.jpg" alt="medical symbol" width="30" height="20"> <a href= "Profile.php">Profile</a> </p>
					<p id = "side_make_appointment"> <img src="person-icon.jpg" alt="medical symbol" width="30" height="20"> <a href="Profile.php">Make Appointment</a> </p>
					<p id = "side_my_appointment"> <img src="person-icon.jpg" alt="medical symbol" width="30" height="20"> <a href="Profile.php">My Appointment</a> </p>
					<p id = "side_logout"> <img src="person-icon.jpg" alt="medical symbol" width="30" height="20"> <a href="Profile.php">Logout</a> </p>
